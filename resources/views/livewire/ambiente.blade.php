<div class="flex flex-col mb-24">
    ...
    <div class="flex flex-col flex items-center  lg:grid lg:grid-cols-6 lg:space-y-24">
        <div class="lg:col-span-2 my-auto zoom-text">
            <div class="w-2/3 mx-auto flex flex-col justify-center items-center align-middle mb-4">
                <h2 class="font-accent text-3xl mt-8 mb-2">Gaststuben</h2>
                <div
        ...
        <div class="lg:col-span-4">
            <img src="{{ asset('images/Gaststube.png') }}" alt="Gaststube"
                class="object-cover w-11/12 h-11/12 lg:w-full zoom-image z-1" loading="lazy" />
        </div>


        <div class="lg:col-span-2 col-start-5 flex items-center align-middle my-auto">
            <div class="w-2/3 mx-auto flex flex-col justify-center items-center zoom-text">
                <h2 class="font-accent text-3xl mt-8">Saal</h2>
                <div
                    class="flex w-full items-center mt-2 justify-center flex-row space-x-2 pb-2 pt-2 lg:pb-4 lg:pt-4 mx-auto ">
                    <div class="h-0.5 bg-black w-full"></div>
        ...
        <div class="lg:col-span-4 col-start-1 mt-8">
            <img src="{{ asset('images/Saal.png') }}" alt="Saal"
                class="object-cover w-11/12 h-11/12 lg:w-full zoom-image z-1" loading="lazy" />
        </div>


        <div class="lg:col-span-2 align-middle flex items-center  my-auto">
            <div class=" w-2/3 mx-auto my-auto flex flex-col justify-center items-center align-middle zoom-text">
                <h2 class="font-accent text-3xl mt-8">Gastgarten</h2>
                <div
                    class="flex w-full items-center mt-2 justify-center flex-row space-x-2 pb-2 pt-2 lg:pb-4 lg:pt-4 mx-auto">
                    <div class="h-0.5 bg-black w-full"></div>
                    <img src="{{ asset('images/Kastanienblatt.png') }}" alt="Kastanien" class="w-8 h-auto kastanienimg">
