<div class="flex flex-col mb-24">
    <div class="hidden lg:flex flex-col lg:flex-row lg:h-[80vh] lg:mb-24">
        <div class="lg:relative lg:flex-grow">
            <div class="relative h-full">
                <img src="{{ asset('images/food/Topfenstrudel_fertig2.jpg') }}" alt="Topfenstrudel" class="object-cover w-full h-full lg:w-full"
                     loading="lazy" />
    ...
    <div class="flex flex-col items-start mb-4 justify-center space-y-4 mx-8 lg:max-w-3xl mx-auto p-8">
    ...
    <section id="food-gallery" class="mt-12">
            <h3 class="text-3xl lg:text-5xl text:lg font-accent lg:mb-8 text-center">zum Schmökern</h3>
        <div class="pswp-gallery grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-8 lg:w-4/5 mx-auto lg:mt-4 mb-16"
             id="roomgallery">
            ...
            <div data-pswp-width="1280" data-pswp-height="857"
               class="block overflow-hidden shadow-lg transition-transform transform hover:scale-120">
                <img src="{{ asset('images/Kaesespetzle.png') }}" alt="Käsespetzle"
